...
function viewport() {
    ...
    var padded_cover = height - $(3.25).toPx({});
    var full = height;
...
jQuery(document).ready(function($){
    ...
    $cart_trigger.on('click', function(event){
        ...
        $('.cart_container').addClass('slide-in');
        $('.cart_container-close').addClass('is-visible');
    ...
    $(document).on('click', '.cd-overlay, .cart_container-close', function(event){
        event.preventDefault();
        $('.cart_container').removeClass('slide-in');
        $('.cart_container-close').removeClass('is-visible');
